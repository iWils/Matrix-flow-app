              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 text-slate-400 dark:text-slate-400 hover:text-slate-200 hover:bg-slate-700 rounded-lg transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="p-2 text-slate-400 dark:text-slate-400 hover:text-red-400 hover:bg-red-900/20 rounded-lg transition-colors"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  {Object.keys(group.permissions || {}).length === 0 && (
                    <p className="text-sm text-slate-500 dark:text-slate-400 italic">{t('admin:noPermissionDefined')}</p>
                  )}
                </div>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder={t('admin:groupRoleDescription')}
            />
          </div>
