...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({
    ...
    const variants = {
      ...
      secondary: 'bg-white text-slate-700 dark:text-slate-400 border border-slate-300 shadow-sm hover:bg-slate-50 hover:shadow-md focus:ring-slate-500 active:bg-slate-100',
      outline: 'border border-slate-300 text-slate-700 dark:text-slate-400 hover:bg-slate-50 hover:border-slate-400 focus:ring-slate-500 active:bg-slate-100',
      ghost: 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-slate-400 hover:bg-slate-100 focus:ring-slate-500 active:bg-slate-200',
